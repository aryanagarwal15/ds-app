...
const disclaimerLines = {
  english: [
    "Namaste, dear one.",
    "Before we begin, I'd like to share a few words to guide your experience.",
    "You may listen to my voice as you fill in the details below.",
    "",
    "DivineSarathi is not a place for medical advice.",
    "It does not offer predictions or astrological readings.",
    "Instead, it shares timeless wisdom — for you to reflect upon.",
    "",
    "This is not just a chatbot that gives you information.",
    "It is your companion — drawing from our scriptures to guide you inward.",
    "",
    "Every word you hear is rooted in the Gita, the Puranas, and the wisdom of our sages.",
    "We do not preach, nor claim absolute truth.",
    "With care and reverence, we share the wisdom passed down through our ancient texts.",
    "",
    "We hold deep respect for all beliefs.",
    "If something does not resonate with you, please gently let it pass.",
    "",
    "This space is sacred.",
    "We assure you that your personal data is safe, secure, and your voice is never recorded.",
    "",
    "Take a breath.",
    "Let us begin.",
  ],
  hindi: [
    "नमस्ते प्रिय भक्त",
    "शुरू करने से पहले, मैं कुछ बातें कहना चाहता हूँ — जो आपके अनुभव को और भी सार्थक बनाएँगी।",
    "आप मुझे सुनते समय नीचे दिए गए प्रश्नों का उत्तर दे सकते हैं।",
    "",
    "DivineSarathi कोई मेडिकल सलाह देने का स्थान नहीं है।",
    "हम न तो भविष्यवाणी करते है, न ही ज्योतिष उपाय देते हैं।",
    "हम केवल सनातन ज्ञान प्रस्तुत करते है — आत्म-चिंतन के लिए।",
    "",
    "यह सिर्फ़ जानकारी देने वाला चैटबॉट नहीं है।",
    "",
    "इसे अपना सारथि मानें — जो शास्त्रों से प्रेरणा लेकर, आपको भीतर की ओर देखने का आमंत्रण देना है।",
    "आप जो भी सुनेंगे, वह भगवद्गीता, पुराणों और हमारे ऋषियों की शिक्षाओं पर आधारित है।",
    "",
    "हम न तो प्रवचन देते हैं, न ही पूर्ण सत्य का दावा करते हैं।",
    "हम निष्ठा और कोमलता से वही प्रस्तुत करते हैं — जो हमारे शास्त्रों में लिखा है।",
    "हम सभी धर्मो और विचार धाराओं का आदर करते हैं।",
    "",
    "यदि कुछ आपसे न जुड़ पाए... तो कृपया उसे अनदेखा करें।",
    "हम आपको आश्वासन करते हैं कि आपकी निजी जानकारी सुरक्षित है और आपकी आवाज़ रिकॉर्ड नहीं की जाती।",
    "",
    "यह स्थान पवित्र है।",
    "एक गहरी साँस लें।",
    "आइए, आरंभ करें।",
